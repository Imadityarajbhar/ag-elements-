// Accurate brand glyphs for this brand's confirmed social platforms (Instagram, Facebook,
// WhatsApp), rendered as inline SVG.
//
// Root cause this file fixes: lucide-react 1.24.0 (this project's icon library) ships no
// brand/logo icons at all (Facebook, Instagram, WhatsApp, etc. are not exported) — they
// were dropped from the package for trademark reasons. The previous footer/contact code
// substituted unrelated generic icons instead (Camera for Instagram, ThumbsUp for
// Facebook, Share2 for a dead "Share" link), which is why the social row never matched any
// real platform. These components use `currentColor` so they inherit the same Tailwind
// text-color/hover classes already used at each call site.
import type { SVGProps } from 'react';

export function FacebookIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M9.101 23.691v-7.98H6.627v-3.667h2.474v-1.58c0-4.085 1.848-5.978 5.858-5.978.401 0 .955.042 1.468.103a8.68 8.68 0 0 1 1.141.195v3.325a8.623 8.623 0 0 0-.653-.036 26.805 26.805 0 0 0-.732-.009c-.207 0-.43.02-.658.09-.325.1-.622.284-.858.532-.264.278-.436.652-.436 1.152v1.756h2.638l-.36 3.667h-2.278v7.98H9.101z" />
    </svg>
  );
}
