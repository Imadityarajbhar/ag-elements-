export function WhatsAppButton() {
  return (
    <a
      ...
      aria-label="Chat with a Jewellery Expert"
    >
      <svg
      ...
      <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover:max-w-xs group-hover:ml-3 font-label-md uppercase tracking-widest font-bold transition-all duration-500 ease-in-out">
        Jewellery Expert
      </span>
    </a>
  );
